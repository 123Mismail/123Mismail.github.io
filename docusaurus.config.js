...
const config = {
  ...
  markdown: {
    mermaid: true,
    // Move deprecated onBrokenMarkdownLinks here for Docusaurus v3/v4 compatibility
    ...
    [
      ...
      ({
        docs: {
          ...
          // FIXED: Use direct plugin references instead of nested arrays for MDX3 compatibility
